import { TextNode, Options } from './interfaces';
...
function showTextNode(textNodeIndex: number) {
  ...
  const textNode: TextNode | undefined = textNodes.find(textNode => textNode.id === textNodeIndex);
...
function showOption(option: Options) {
...
const textNodes: TextNode[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Prova new text',
        requiredState: (currentState: any) => currentState.blossomFlower,
        nextText: -1
      },
      {
